...
public class CameraMovement : MonoBehaviour
{
    ...
    //How fast would you want to move the camera?
    //Serialized floats so that these values could get edited in the editor.

    private float _minimumX = -360f;
    private float _maximumX = 360f;

    //Amount of rotation the X axis could get rotated.

    private float _minimumY = -60f;
    private float _maximumY = 60f;

    //Amount of rotation the Y axis could get rotated.
